<div class="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
    ...
    <div class="relative mb-8 text-center">
        <div class="absolute top-2 right-2 z-10 flex gap-2">
            ...
            <button wire:click="toggleLove" class="bg-white text-2xl p-2 rounded-md w-10 h-10 flex justify-center items-center transition-colors duration-300 shadow-sm hover:bg-gray-50">
                <svg xmlns="http://www.w3.org/2000/svg" fill="{{ $isLoved ? 'red' : 'none' }}" viewBox="0 0 24 24" stroke="currentColor" class="w-6 h-6 text-black transition-colors duration-300">
            ...
            <!-- Button Link -->
            <button class="bg-white text-gray-500 text-2xl p-2 rounded-md w-10 h-10 flex justify-center items-center shadow-sm hover:bg-gray-50">
    ...
    <div class="mt-8">
        <p class="text-gray-700 mb-4 mx-auto max-w-prose">
        ...
        @for ($i = 1; $i <= 5; $i++)
            <div class="mb-8">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-700 text-left max-w-2xl">
