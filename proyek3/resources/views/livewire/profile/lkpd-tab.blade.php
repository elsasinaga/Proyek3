<div>
    <!-- LKPD Sub Tabs -->
    <div class="flex space-x-4 mb-24 justify-center">
        <button 
            wire:click="$set('activeSubTab', 'upload')"
            class="px-4 py-2 rounded {{ $activeSubTab === 'upload' ? 'bg-green-500 text-white' : 'bg-gray-200' }}"
        >
            Upload (3)
        </button>
        <button 
            wire:click="$set('activeSubTab', 'draft')"
            class="px-4 py-2 rounded {{ $activeSubTab === 'draft' ? 'bg-green-500 text-white' : 'bg-gray-200' }}"
        >
            Draft (1)
        </button>
    </div>
