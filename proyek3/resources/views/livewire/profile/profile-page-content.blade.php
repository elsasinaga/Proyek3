                ...
                <div class="ml-6 flex-grow">
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex space-x-2">
                            <button class="p-2 rounded-md bg-gray-200" icon="x-heroicon-o-cog-8-tooth">
            ...
            <div class="flex space-x-8 justify-end">
                <div class="flex space-x-8">
                    ...
                    <button 
                        ...
                        class="flex items-center pb-4 border-b-2 {{ $activeTab === 'favorit' ? 'border-blue-500 text-blue-500' : 'border-transparent hover:border-gray-300' }}"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button 
                        ...
                        class="flex items-center pb-4 border-b-2 {{ $activeTab === 'lkpd' ? 'border-blue-500 text-blue-500' : 'border-transparent hover:border-gray-300' }}"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
