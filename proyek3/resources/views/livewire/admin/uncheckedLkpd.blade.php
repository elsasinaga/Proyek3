                    ...
                    <th>
                        <div class="grid grid-cols-3 gap-0.1">
                            <div class="col-span-1">
                                {{-- <x-button class="btn" @click="$wire.openLkpdModal({{ $lkpd->id }});" style="background-color:#605DEC; color: white;">
                                ...
                                {{-- <button>
                                    <a href="{{ route('lkpd.detail', $lkpd->id) }}" class="btn btn-primary">
                                        <i class="fa-regular fa-eye"></i> Lihat Detail
                                    </a>
                                </button> --}}
                            </div>
                            <div class="col-span-1">
                                <button wire:click="verifyLkpd({{ $lkpd->id }})" class="btn btn-success" style="color: white;">
